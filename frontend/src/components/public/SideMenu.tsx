          ...
          <div className="grid grid-cols-12 gap-3 sm:gap-5 my-auto flex-1 items-start pt-3.5 pb-2 md:pt-3 md:pb-1">
            ...
            <div className="col-span-5 flex flex-col gap-4 sm:gap-4 md:gap-3.5 border-r border-rpo-black/[0.08] pr-2.5 sm:pr-3">
              ...
              <div className="flex flex-col">
                <h4 className="text-rpo-black/50 text-[11px] sm:text-xs md:text-[10px] font-mono font-bold uppercase tracking-wider mb-1">
                  Resources
                </h4>
                      ...
                      <li key={link.name}>
                        <Link 
                          ...
                          className={cn(
                            ...
                            isActive ? "text-sougen-blue font-bold" : "text-rpo-black/80 hover:text-sougen-blue"
                          )}
                        >
                          {link.name}
                        </Link>
                  ...
                  {contactLinks.map((link) => (
                    <li key={link.name}>
                      <a 
                        ...
                        className="text-sm sm:text-base md:text-[13px] font-semibold text-rpo-black/80 hover:text-sougen-blue transition-colors duration-200 flex items-center justify-between group py-1 md:py-0.5"
                      >
                        <span>{link.name}</span>
                        <ExternalLink className="w-3.5 h-3.5 md:w-3 md:h-3 text-rpo-black/30 group-hover:text-sougen-blue transition-colors" />
                      </a>
                    </li>
                  ))}
                </ul>
