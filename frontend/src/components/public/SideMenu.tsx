          ...
          <div className="grid grid-cols-2 gap-[27px] max-[515px]:gap-[15px] h-full overflow-x-hidden">
            ...
            <div className="flex flex-col gap-[27px]">
              ...
              <div className="flex flex-col">
                <h4 className="text-[#777777] text-xs font-semibold mb-[10px] uppercase">Resources</h4>
              ...
              {/* Get in touch */}
              <div className="flex flex-col">
                <h4 className="text-[#777777] text-xs font-semibold mb-[10px] uppercase">Get in touch</h4>
                <ul className="flex flex-col gap-[8px] p-0 m-0 list-none">
              ...
              {/* Social */}
              <div className="flex flex-col">
                <h4 className="text-[#777777] text-xs font-semibold mb-[10px] uppercase">Social</h4>
                <ul className="flex flex-col gap-[8px] p-0 m-0 list-none">
            ...
            {/* Right Column */}
            <div className="flex flex-col">
              <h4 className="text-[#777777] text-xs font-semibold mb-[10px] pl-[10px] uppercase">Menu</h4>
