...
export function BottomNav() {
  ...
  useEffect(() => {
    ...
    if (window.visualViewport) {
      window.visualViewport.addEventListener('resize', updateKeyboardStatus, { passive: true });
      window.visualViewport.addEventListener('scroll', updateKeyboardStatus, { passive: true });
    }
    window.addEventListener('resize', updateKeyboardStatus, { passive: true });
