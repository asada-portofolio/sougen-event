          ...
          >
            <div
              className={cn(
                ...
                isActive ? 'bg-sougen-blue/10 text-sougen-blue-dark font-black' : 'text-rpo-black/70 hover:text-rpo-black'
              )}
            >
              <Icon className={cn('h-6 w-6', isActive ? 'text-sougen-blue-dark' : 'text-rpo-black/70')} />
              <span className="text-[11px] font-inter font-bold uppercase tracking-wider mt-1">
                {item.name}
              </span>
            </div>
          </Link>
