...
>(({ className, children, ...props }, ref) => (
  <ModalPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md opacity-70 ring-offset-white transition-all hover:opacity-100 hover:text-sougen-blue focus:outline-none focus:ring-2 focus:ring-sougen-blue focus:ring-offset-2 disabled:pointer-events-none data-[state=open]:bg-black/5 data-[state=open]:text-rpo-black text-rpo-black/50">
        <X className="h-4 w-4" />
