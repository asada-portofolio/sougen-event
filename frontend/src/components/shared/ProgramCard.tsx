    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden rounded-xl">
        ...
        <div className="absolute inset-x-0 bottom-0 flex flex-col justify-end p-4 pb-10 z-10 text-center">
          <h3 className="font-poppins text-xl md:text-2xl font-bold text-gray-900 group-hover:text-sougen-blue-dark transition-colors duration-300 leading-tight line-clamp-2">
            {title}
          </h3>
        </div>
      </div>
