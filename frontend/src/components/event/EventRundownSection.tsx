      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-6 lg:hidden flex justify-between items-start mx-auto max-w-[90%] bg-white p-4 rounded-xl border border-rpo-black/5 shadow-sm relative z-0">
          <div className="flex flex-col gap-1.5 w-full">
            <h4 className="font-poppins font-bold text-rpo-black text-sm text-center">{formatDate(activeDay.date)}</h4>
            <div className="flex items-center justify-center gap-1.5 text-sougen-blue font-inter text-xs font-semibold bg-sougen-blue/10 w-full px-2 py-1.5 rounded-md">
  ...
  return (
    <div className="bg-[#FAFAFA] p-6 md:p-8 rounded-xl border border-rpo-black/5 h-full">
      <div className="flex items-center gap-3 mb-2">
        <span className="bg-sougen-blue text-white font-poppins font-bold text-sm px-3 py-1 rounded-md">
          Day {day.dayNumber}
        </span>
      </div>
        ...
        {day.rundownItems.map((item) => (
          <div key={item.id} className="relative">
            ...
            <div className="bg-white p-4 rounded-lg border border-rpo-black/5 hover:border-sougen-blue/30 transition-colors duration-300">
              <div className="flex items-center gap-2 text-sougen-blue font-inter text-sm font-bold mb-1.5">
