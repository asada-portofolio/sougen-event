          ...
          <div className="md:hidden w-full max-w-[320px] mx-auto px-4 relative z-10">
            <div className="relative flex flex-col bg-white rounded-[20px] overflow-hidden shadow-[0_20px_60px_rgba(0,0,0,0.6)]">
              ...
              <div className="px-6 pt-6 pb-5 flex flex-col items-center text-center">
                ...
                {/* Tema */}
                {event.theme && (
                  <div className="font-inter font-semibold text-gray-900 text-xs uppercase tracking-[0.12em] mt-1 mb-3">
                    {event.theme}
                  </div>
                )}

                {/* Lokasi */}
                <div className="flex items-center gap-1.5 text-gray-700 font-medium text-xs mt-3 w-full justify-center">
              ...
              <div className="px-6 pt-5 pb-6 flex items-center justify-center bg-gray-50/50">
                <Button asChild className="w-full h-11 text-xs font-bold uppercase tracking-[0.15em]" variant="primary">
