    ...
    return (
      <>
        <section className="relative w-full h-screen min-h-[600px] overflow-hidden bg-rpo-black flex items-center justify-center">
          ...
          <div className="md:hidden w-full max-w-[325px] mx-auto px-4 relative z-10">
            <div className="relative flex flex-col bg-white rounded-[22px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.15)]">
              ...
              <div className="pt-3.5 pb-2.5 px-5 text-center flex flex-col items-center">
                ...
                <div 
                  style={{ backgroundColor: accentColor || '#0070AC' }} 
                  className="inline-flex items-center gap-1.5 font-mono text-[9.5px] font-bold text-white uppercase tracking-wider mt-1.5 px-2.5 py-0.5 rounded-full shadow-sm transition-colors duration-500"
                >
                ...
                <div className="w-full bg-[#FAFAFA] rounded-xl p-3 border border-black/5 space-y-2 text-left">
                  ...
                  <div className="flex items-center gap-2.5">
                    <Calendar 
                      ...
                      className="w-4 h-4 p-1.5 box-content rounded-lg shrink-0 transition-colors duration-500"
                    />
                    <div className="flex flex-col min-w-0">
                      <span className="font-mono text-[10px] font-bold text-gray-600 uppercase tracking-wider leading-none">
                        TANGGAL
                      </span>
                      <span className="font-inter font-bold text-xs text-rpo-black mt-0.5 truncate">
                  ...
                  {event.location ? (
                    ...
                    >
                      ...
                      <div className="flex flex-col min-w-0 flex-1">
                        <span className="font-mono text-[10px] font-bold text-gray-600 uppercase tracking-wider leading-none flex items-center gap-1">
                          LOKASI <ExternalLink className="w-2.5 h-2.5 opacity-60 group-hover/loc:opacity-100 transition-opacity" />
                        </span>
                        <span className="font-inter font-bold text-xs text-rpo-black mt-0.5 truncate group-hover/loc:text-sougen-blue group-hover/loc:underline transition-colors">
                          {event.location}
                        </span>
                      </div>
                    </a>
              ...
              <div className="p-4 bg-gray-50/80 flex flex-col gap-2">
                ...
                {event.registrationUrl && (
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-full h-9 inline-flex items-center justify-center gap-1.5 px-4 bg-white hover:bg-sougen-blue-dark hover:text-white text-rpo-black border border-black/15 rounded-xl transition-all duration-300 font-inter text-xs font-bold shadow-sm"
                  >
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-rpo-black px-4 lg:px-8 py-24">
        ...
        <div className="relative z-10 max-w-5xl w-full mx-auto text-center flex flex-col items-center md:mt-16">
          {hasEvent ? (
            <>
              {/* MOBILE: Modern Holographic Festival Pass (Concept A Refined) */}
              <div className="md:hidden w-full max-w-[325px] mx-auto px-4 relative z-10 mt-2">
                <div className="relative flex flex-col bg-white rounded-[22px] overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.15)]">
