...
export default function GalleryDetail() {
  ...
  // Format slides for Lightbox (dengan tautan unduh resolusi penuh)
  const lightboxSlides = photos.map((p, idx) => ({
    ...
    download: {
      ...
      filename: `${eventData?.slug || 'sougen'}-dokumentasi-${idx + 1}.webp`,
    },
  }));
  ...
  return (
    <div className="w-full min-h-screen bg-[#FAFAFA] text-rpo-black pt-20 sm:pt-24 md:pt-28 pb-20">
      ...
      <Lightbox
        ...
        plugins={[Zoom, Thumbnails, Counter, Captions, Download, Fullscreen]}
